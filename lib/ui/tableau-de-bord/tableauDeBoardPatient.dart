...
class tableauDeBoardPatient extends StatefulWidget {
  const tableauDeBoardPatient({super.key});

  @override
  State<tableauDeBoardPatient> createState() => _tableauDeBoardPatientState();
}

class _tableauDeBoardPatientState extends State<tableauDeBoardPatient> {
  @override

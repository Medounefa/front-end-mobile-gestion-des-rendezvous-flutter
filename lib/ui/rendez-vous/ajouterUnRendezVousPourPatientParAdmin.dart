...
class AjouterRendezVousPourPatientParAdmin extends StatefulWidget {
  const AjouterRendezVousPourPatientParAdmin({super.key});

  @override
  State<AjouterRendezVousPourPatientParAdmin> createState() =>
      _AjouterRendezVousPourPatientParAdminState();
}

class _AjouterRendezVousPourPatientParAdminState
    extends State<AjouterRendezVousPourPatientParAdmin> {

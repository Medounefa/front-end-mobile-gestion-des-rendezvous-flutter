...
class AjouterUnMedecin extends StatefulWidget {
  const AjouterUnMedecin({super.key});

  @override
  State<AjouterUnMedecin> createState() => _AjouterUnMedecinState();
}

class _AjouterUnMedecinState extends State<AjouterUnMedecin> {
  @override
                  ...
                  Container(
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          decoration: InputDecoration(
                            hintText: "Entrer specialisation",
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(10),
                            ),
                          ),
